...
class CourseController extends Controller_BaseModel{
    function newlistAction(){
        if(Request::getStringParam('do')==='getcourselist'){
          Response::json_success(
            Cms_Service_Api_Contents_Course::getInstance()->getListOfRules(
              Request::parse_Base64_JSON_Param('params',true),
  ...
  function idAction(){
  	$this->redirect('/pc/course/play?id='.Request::getIntParam('id'));
  }
  function playAction(){
